    ...
    .row.fondotema3.align-items-center.row.justify-content-center
          ...
          .col-lg-10
            PasosA.color-acento-contenido.mb-0(tipo="l")
              .row.align-items-center.justify-content-center
                ...
                .col-auto
                  figure(data-aos="zoom-in")
                    img.d-none.d-lg-block(src='@/assets/curso/temas/tema3/img1-1.png')
              .row.align-items-center.justify-content-center
                .col-auto
                  figure(data-aos="zoom-in")
                    img.d-none.d-lg-block(src='@/assets/curso/temas/tema3/img1-2.png')
                .col-lg
              ...
              .row.align-items-center.justify-content-center
                ...
                .col-auto
                  figure(data-aos="zoom-in")
                    img.d-none.d-lg-block(src='@/assets/curso/temas/tema3/img1-3.png')
              .row.align-items-center.justify-content-center
                .col-auto
                  figure(data-aos="zoom-in")
                    img.d-none.d-lg-block(src='@/assets/curso/temas/tema3/img1-4.png')
                .col-lg
        ...
        .row.justify-content-center.mb-5.ps-5
          ...
          .col-12.col-md-8.col-lg-4
            img.mb-5.mt-4(src='@/assets/curso/temas/tema3/imagen1.png')(data-aos="fade-right")
