      ...
      preguntas: [
        {
          id: 1,
          texto:
            'El servicio es el conjunto de actividades que se realizan para satisfacer las necesidades de los clientes, desde que tienen contacto con la empresa hasta finalizar el ciclo del servicio.',
        ...
        },
        {
          id: 3,
          texto:
            'La atención y el servicio al cliente solo consta de ofrecer experiencias significativas a los clientes.',
        ...
        },
        {
          id: 4,
          texto:
            'La fidelización se debe entender cómo una acción de la empresa para lograr conseguir relaciones con los clientes que generen acciones redituables y continuadas con la empresa a lo largo del tiempo.',
        ...
        },
        {
          id: 5,
          texto:
            'NTC - ISO 9000-2051 es la norma técnica de gestión de la calidad vigente para el servicio al cliente.',
          imagen: require('@/assets/actividad/imagen1.png'),
          barajarRespuestas: true,
          opciones: [
            { id: 'a', texto: 'Verdadero', esCorrecta: false },
        ...
        },
        {
          id: 7,
          texto:
            'Los ciclos de servicio permiten a la empresa entender la realidad de la experiencia del servicio al cliente. ',
          imagen: require('@/assets/actividad/imagen3.png'),
          barajarRespuestas: true,
          opciones: [
            { id: 'a', texto: 'Verdadero', esCorrecta: true },
        ...
        },
        {
          id: 9,
          texto:
            'El soporte interno es uno de los elementos que favorecen los momentos de verdad.',
          imagen: require('@/assets/actividad/imagen1.png'),
          barajarRespuestas: true,
          opciones: [
            { id: 'a', texto: 'Verdadero', esCorrecta: true },
        ...
        },
        {
          id: 10,
          texto:
            'La norma ISO 9000 regula las normas de control de calidad y gestión de calidad del proceso en la trazabilidad.',
          imagen: require('@/assets/actividad/imagen2.png'),
          barajarRespuestas: true,
          opciones: [
            { id: 'a', texto: 'Verdadero', esCorrecta: true },
